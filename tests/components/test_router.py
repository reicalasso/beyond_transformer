...
from nsm.components import TokenToStateRouter
...
class TestTokenToStateRouter(unittest.TestCase):
    ...
    def test_forward_pass_shapes(self):
        ...
        self.assertEqual(routed_tokens.shape, (self.batch_size, self.num_states, self.state_dim))
        
        # Check routing weights shape
        self.assertEqual(routing_weights.shape, (self.batch_size, self.seq_len, self.num_states))
