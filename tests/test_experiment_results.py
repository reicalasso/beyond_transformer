...
def test_experiment_results_basic():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        filepath = results_manager.save_experiment_results("test_experiment", example_results)
        ...
        assert loaded_results['results']['state_counts'] == example_results['state_counts']
        ...
        assert list(df.columns) == ["state_counts", "accuracies", "memory_usages", "training_times"]
...
def test_experiment_results_processed():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        filepath = results_manager.save_processed_results("test_processed", processed_data)
        assert os.path.exists(filepath)
