"""
Visualization Tools for PULSE Interpretability
...
class PULSEVisualizer:
    """
    Visualizer for PULSE interpretability.
    """
    ...
    def plot_attention_map(
        ...
        # Plot heatmap
        im = sns.heatmap(
            attention_map, annot=False, cmap="viridis", square=True, cbar=True, ax=ax
        )
    ...
    def plot_memory_content(
        ...
        # Plot heatmap
        im = sns.heatmap(
            memory_content, annot=False, cmap="RdBu_r", center=0, cbar=True, ax=ax
        )
    ...
    def plot_state_evolution(
        ...
        mean_states = [
            np.mean(state, axis=1) for state in state_arrays
        ]  # Mean per slot
...
if __name__ == "__main__":
    print("Testing PULSE Visualizer...")
    ...
    fig5 = visualizer.plot_memory_importance(
        importance_scores, "Test Memory Importance"
    )
    ...
    print("✅ PULSE Visualizer test completed!")
