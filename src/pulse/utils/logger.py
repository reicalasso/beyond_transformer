...
class PULSELogger:
    """
    Logger for PULSE components.
    """

    def __init__(self, log_dir: str = "logs", experiment_name: str = "pulse_test"):
        """
        Initialize the PULSELogger.
...
if __name__ == "__main__":
    print("Testing PULSELogger...")

    # Create logger
    logger = PULSELogger(experiment_name="test_experiment")
    ...
    print("✅ PULSELogger test completed successfully!")
