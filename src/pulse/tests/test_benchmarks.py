...
try:
    ...
    from pulse.benchmarks.babi_benchmark import bAbIBenchmark, bAbIDataset
    from pulse.benchmarks.comprehensive_benchmark import ComprehensiveBenchmark
    from pulse.benchmarks.lra_benchmark import LRABenchmark, LRADataset
    from pulse.benchmarks.pg19_benchmark import PG19Benchmark, PG19Dataset
except ImportError:
